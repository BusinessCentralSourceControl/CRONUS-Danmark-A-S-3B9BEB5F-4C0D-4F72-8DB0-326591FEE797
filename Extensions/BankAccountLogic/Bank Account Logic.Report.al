Report 56790 "Bank Account Logic"
{
    WordLayout = './Layouts/BankAccountLogic.docx';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("Bank Account";"Bank Account")
        {
            ...
            column(ReportForNav_BankAccount;ReportForNavWriteDataItem('BankAccount', "Bank Account"))
            {
            }
            trigger OnPreDataItem();
            begin
                ReportForNav.OnPreDataItem('BankAccount', "Bank Account");
            end;
        }
    }
    requestpage
    ...
    begin
        ...
        case(dataItemId)of 'BankAccount': begin
            currLanguage:=GlobalLanguage;
            GlobalLanguage:=1033;
            jsonObject.Add('DataItem$BankAccount$CurrentKey$Text', "Bank Account".CurrentKey);
